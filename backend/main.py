...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    4. Embedded via NVIDIA NIM and stored in ChromaDB
...
async def chat_with_pdf(request: ChatRequest):
    ...
    The question is:
    1. Embedded via NVIDIA NIM and used to query ChromaDB
    2. Relevant chunks retrieved via cosine similarity
    3. Passed to NVIDIA NIM LLM with a grounded system prompt
    4. Answered with citations or a clean refusal
...
async def delete_document(document_id: str):
    """Delete a processed document and its chunks from ChromaDB."""
