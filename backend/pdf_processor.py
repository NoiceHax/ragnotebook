...
Chunking Strategy:
    Character-based overlapping chunks with sentence-boundary awareness.
    Each chunk is up to CHUNK_SIZE characters, with CHUNK_OVERLAP characters
    of overlap between consecutive chunks. When possible, chunks break at
    sentence boundaries (". " or newline) to avoid mid-sentence splits.
    Each chunk retains its source page number for accurate citations.
"""
